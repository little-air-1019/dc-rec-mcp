// Ported verbatim from Craig (apps/bot/src/modules/recorder/crc32.ts) — read-only
// reference. Byte-exact CRC32 so our OGG pages match what cook.sh/oggtracks expect.
